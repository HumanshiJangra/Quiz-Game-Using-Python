...
time.sleep(1)
questions=["Who developed the Python language?","In which year was the Python language developed?","In which language is Python written?","What is the Latest Version of Windows Since 2019","Which one of the following is the correct extension of the Python file?","How Many MB Makes 1 GB","Facebook Was Firstly Developed By","Founder of Apple is","_________ is one of The Founder of Google","BIGG BOSS season 13 Starts in ____ & ends in _____","Apple's Laptop is Also Known as","First Apple Computer is Known as","Joystick is used For","In which year was the Python 3.0 version developed?"]
answer=["Guido van Rossum","1989","C","Windows 10",".py","1024","Mark Zuckenberg","Steve Jobs","Larry Page","2019 - 2020","Macbook","Mactonish","Playing Games","2008"]
wronganswers=[["Zim Den","Niene Stom","Wick van Rossum"],["1994","1972","1999"],["PHP","FORTRAN","ENGLISH"],["Windows 7","Windows 8","Windows 11"],[".python",".p",".pa"],["Oracle","Microsoft","Google"],["Bill Gates","Larry Page","Azhar Ansari"],["Azhar Ansari","Charles Babbage","Sundar Pichai"],["Larry Hensberg","Sunder Pichai","Bill Gates"],["2020 - 2021","Not Starts Now","2018 - 2019"],["ThinBook","Notebook","ChromeBook"],["Apple v.1","Apple Computer","Appbook"],["Giving output command","Shutting down Computer","Log off Computer"],["2000","2005","2010"]]
attempquestion=[]
count=1
amount=0
while True:
